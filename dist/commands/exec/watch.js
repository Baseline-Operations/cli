 ...
 */
import { watchRepositories } from "@baseline/core/commands";
import { Logger } from "@baseline/core/utils";
export async function watchCommand(options = {}) {
    try {
        const watchOptions = {
            ...options,
            onFileChange: (repo, filePath) => {
        ...
        Logger.error(`Failed to watch repositories: ${error instanceof Error ? error.message : String(error)}`);
        process.exit(1);
    }
}
